...
class Mc
{
    ...
    public function sendRequest($consignmentNumber, $status, $isTest = null, $hookId)
    {
        $this->statuses = ['RETURN', 'DELIVERED', 'IN_TRANSIT'];
        $this->hookId = $hookId;
        $this->status = $isTest ? $this->statuses[rand(0, 2)] : $status;
    ...
    public function sendInTransitMessage()
    {
        ...
        if ($response->status() == 200) {
            ...
            $bringOrder = BringOrder::where('hook_id', $this->hookId)->first();
